...
class JoinProgrammedMapScreen extends StatefulWidget {
  @override
  _JoinProgrammedMapScreenState createState() => _JoinProgrammedMapScreenState();
}

class _JoinProgrammedMapScreenState extends State<JoinProgrammedMapScreen> {
